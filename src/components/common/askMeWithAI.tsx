  ...
  return (
    <div className="fixed bottom-12 left-1/2 -translate-x-1/2 z-50">
      <div className="relative flex justify-center">
        ...
        <div
          className={`relative overflow-hidden rounded-full border-2 border-[#FFB7C5] bg-[#FFF5F7] transition-all duration-500 ease-in-out ${
            showInput
        ...
        >
          <div
            className={`absolute inset-0 flex items-center justify-center px-6 text-[#5d4037] font-bold tracking-wide transition-all duration-300 ${
