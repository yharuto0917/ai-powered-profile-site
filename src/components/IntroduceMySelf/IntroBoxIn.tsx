      ...
      >
        <div className="flex flex-col md:flex-row items-center md:items-center justify-center gap-8 md:gap-14 w-full max-w-5xl">
          <Image
            ...
            width={150}
            height={150}
            className="rounded-full border-4 border-pink-50 w-24 h-24 sm:w-32 sm:h-32 md:w-[150px] md:h-[150px]"
          />
          <div className="flex flex-col gap-4 text-center md:text-left max-w-3xl">
            ...
            <p className="text-gray-600 text-base sm:text-lg leading-relaxed max-w-2xl mx-auto md:mx-0">
              I am a Deep Learning Engineer majoring in LLMs. I aim to advance SLMs operating
              on-device to a frontier level using inference techniques based on improved
              quantization technology and reinforcement learning based reasoning.
              <br />
              <br />
              I am also developing web applications using Next.js, Vite, React, TypeScript, Tailwind
              CSS and more. I aim to make AI easier and more accessible for many people through AI
