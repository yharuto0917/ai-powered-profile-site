    ...
    return (
        <div className="flex justify-center pt-5">
            <div className="grid grid-cols-1 md:grid-cols-3 gap-6 w-full">
                ...
                <div className="flex flex-col gap-2 bg-white/90 rounded-3xl shadow-lg shadow-pink-100 border border-pink-100 p-8 w-full">
                ...
                <div className="flex flex-col gap-2 bg-white/90 rounded-3xl shadow-lg shadow-pink-100 border border-pink-100 p-8 w-full">
                    ...
                    <div className="flex flex-col gap-2">
                        <ul>
                            ...
                            <li className="text-gray-600 text-xl">・Google Antigravity</li>
                            <li className="text-gray-600 text-xl">and more...</li>
                        </ul>
                    </div>
                </div>
