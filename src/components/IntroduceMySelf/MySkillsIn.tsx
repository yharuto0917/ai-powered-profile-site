...
export default function MySkillsIn() {
    return (
        <div className="flex justify-center pt-5 gap-10">
            ...
            <div className="flex flex-col gap-2 bg-white/90 rounded-3xl shadow-lg shadow-pink-100 border border-pink-100 p-8 w-[25rm]">
                <p className="text-pink-300 text-2xl font-bold">Programming Languages</p>
                <div className="flex flex-col gap-2">
                    <ul>
                        ...
                        <li className="text-gray-600 text-xl">・Dart</li>
            ...
            {/* Frameworks */}
            <div className="flex flex-col gap-2 bg-white/90 rounded-3xl shadow-lg shadow-pink-100 border border-pink-100 p-8 w-[25rem]">
                <p className="text-pink-300 text-2xl font-bold">Frameworks</p>
                <div className="flex flex-col gap-2">
                    <ul>
                        ...
                        <li className="text-gray-600 text-xl">・Hono.js</li>
            ...
            {/* Development Tools */}
            <div className="flex flex-col gap-2 bg-white/90 rounded-3xl shadow-lg shadow-pink-100 border border-pink-100 p-8 w-[25rm]">
                <p className="text-pink-300 text-2xl font-bold">Development Tools</p>
                <div className="flex flex-col gap-2">
                    <ul>
                        ...
                        <li className="text-gray-600 text-xl">・Cloudflare</li>
                        <li className="text-gray-600 text-xl">・Cursor</li>
                        <li className="text-gray-600 text-xl">・Claude Code</li>
                        <li className="text-gray-600 text-xl">・Goole Antigravity</li>
                        <li className="text-gray-600 text-xl">and more...</li>
                    </ul>
                </div>
            </div>
